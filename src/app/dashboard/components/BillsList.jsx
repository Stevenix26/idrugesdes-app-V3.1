        ...
        return (
            <div className="text-center py-12 bg-white rounded-lg shadow">
                ...
                <p className="mt-1 text-sm text-gray-500">
                    You don&apos;t have any bills yet. They will appear here once your prescriptions are processed.
                </p>
                <div className="mt-6">
                    <Link
            ...
            <div className="sm:flex sm:items-center">
                <div className="sm:flex-auto">
                    ...
                    <p className="mt-2 text-sm text-gray-700">
                        A list of all bills for your prescriptions.
                    </p>
                </div>
            </div>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-sm text-gray-500">
                                                {bill.prescription?.medication || 'Medication N/A'}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-4 border-t border-gray-200 pt-4">
                                        <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                                            ...
                                            <div>
                                                ...
                                                <dd className="mt-1 text-sm text-gray-900">{formatDate(bill.prescription?.prescriptionDate)}</dd>
                                            </div>
                                            <div>
