...
const roleOptions = [
  {
    ...
    title: "Patient",
    description:
      "Sign up as a patient to order medications and manage prescriptions",
  ...
  },
  {
    ...
    title: "Pharmacist",
    description:
      "Sign up as a pharmacist to manage pharmacy and handle prescriptions",
  ...
  },
  {
    id: "ADMIN",
    title: "Administrator",
    description: "Sign up as an administrator (requires approval)",
