        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
          ...
          <div className="mb-8">
            <div className="flex items-center mb-5">
              <div className="w-32 h-12 bg-gradient-to-r from-white to-indigo-300 rounded-full flex items-center justify-center mr-3 shadow-lg transform transition-transform hover:scale-110 duration-300">
                <Link href="/">
