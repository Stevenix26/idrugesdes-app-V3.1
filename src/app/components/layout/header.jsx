...
//   return (
//     <>
//       <header className='z-10 pb-3 text-stone-400 fixed-top'>
//         {/* Navbar */}
//         <Navbar fixed shadow>
//           <NavbarBrand>
//             <Link href='/'>
...
//           <NavbarContent>
//             <NavbarItem>
//               <Link href='/shops' color='warning' className='hover:bg-gray-400'>
//                 Shops
//               </Link>
//             </NavbarItem>
//             <NavbarItem>
//               <Link href='/store' color='warning' className='hover:bg-gray-400'>
//                 Store
//               </Link>
//             </NavbarItem>
//             <NavbarItem>
